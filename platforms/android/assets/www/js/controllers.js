...
.controller('EstudiantesCtrl', function($http, $scope, $stateParams, $timeout, $state, ionicMaterialInk, ionicMaterialMotion, sessionService) {
    ...
    $scope.guardarEstudiante = function(id_estudiante) {
        sessionService.destroy('id_estudiante_actual');
...
.controller('EvaluarCtrl', function($http, $scope, $stateParams, $timeout, ionicMaterialInk, ionicMaterialMotion, sessionService) {
    $scope.$parent.showHeader();
    $scope.$parent.clearFabs();
    $scope.isExpanded = false;
    $scope.$parent.setExpanded(false);
    ...
    $scope.init = function() {
        // console.log(sessionService.get('id_curso'));
            ...
            $http.get('http://applectura.tide.cl/api/app/users/' + sessionService.get('id_estudiante_actual'))
                        .success(function(response) {
...
.controller('GalleryCtrl', function($scope, $stateParams, $timeout, ionicMaterialInk, ionicMaterialMotion,sessionService) {
    $scope.$parent.showHeader();
    $scope.$parent.clearFabs();
    $scope.isExpanded = false;
    $scope.$parent.setExpanded(false);
